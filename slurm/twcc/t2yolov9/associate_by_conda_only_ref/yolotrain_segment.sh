...
## 主要使用singularity, 部分使用python-user
...
## 主要使用singularity, 部分使用最小化安裝的 conda env (yolo9t2)
...
### (tb delete) export PYTHONPATH=/home/waue0920/.local/lib/python3.10/site-packages:/home/waue0920/anaconda3/envs/yolo9t2/lib/python3.10/site-packages:$PYTHONPATH
### (tb delete) export PYTHONPATH=/home/waue0920/.local/lib/python3.10/site-packages:/usr/local/lib/python3.10/dist-packages


## 完全使用conda, 清除 singularity 內的 python環境
#unset PYTHONHOME
#unset PYTHONPATH
